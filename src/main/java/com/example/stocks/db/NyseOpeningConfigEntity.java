...
/**
 * NYSE Opening Range Breakout Scanner config (single row, id=1).
 * NYSE market hours: 09:30-16:00 ET
 * Range: 09:30-10:00, Entry: 10:00-11:30, Session end: 15:45
 */
@Entity
@Table(name = "nyse_opening_config")
public class NyseOpeningConfigEntity {
    ...
    private BigDecimal slPct = BigDecimal.valueOf(2.8);

    @Column(name = "trail_atr_mult", nullable = false, precision = 5, scale = 2)
    private BigDecimal trailAtrMult = BigDecimal.valueOf(0.7);
    ...
    private boolean openFailedEnabled = true;

    // -- Quick TP --
    @Column(name = "quick_tp_enabled", nullable = false)
    private boolean quickTpEnabled = false;
    ...
    public void setOrderSizingValue(BigDecimal orderSizingValue) { this.orderSizingValue = orderSizingValue != null ? orderSizingValue : BigDecimal.valueOf(33); }
    ...
    public void setSlPct(BigDecimal v) { this.slPct = v != null ? v : BigDecimal.valueOf(2.8); }

    public BigDecimal getTrailAtrMult() { return trailAtrMult; }
    public void setTrailAtrMult(BigDecimal v) { this.trailAtrMult = v != null ? v : BigDecimal.valueOf(0.7); }
