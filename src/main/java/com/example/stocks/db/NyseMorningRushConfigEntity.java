...
/**
 * NYSE Morning Rush Scanner config (single row, id=1).
 * NYSE gap-up + pre-market high breakout scanner.
 * Entry at 09:30:30 ET (30sec delay), price > PM high x 1.02, gap > 4%, volume 2x.
 * Session end: 10:30 ET.
 */
@Entity
@Table(name = "nyse_morning_rush_config")
public class NyseMorningRushConfigEntity {
    ...
    private BigDecimal gapThresholdPct = BigDecimal.valueOf(4.0);

    @Column(name = "pm_high_breakout_pct", nullable = false, precision = 5, scale = 2)
    private BigDecimal pmHighBreakoutPct = BigDecimal.valueOf(2.0);

    @Column(name = "volume_mult", nullable = false, precision = 5, scale = 2)
    private BigDecimal volumeMult = BigDecimal.valueOf(2.0);
    ...
    private int sessionEndMin = 30;

    @Column(name = "time_stop_min", nullable = false)
    private int timeStopMin = 20;
    ...
    public void setGapThresholdPct(BigDecimal v) { this.gapThresholdPct = v != null ? v : BigDecimal.valueOf(4.0); }

    public BigDecimal getPmHighBreakoutPct() { return pmHighBreakoutPct; }
    public void setPmHighBreakoutPct(BigDecimal v) { this.pmHighBreakoutPct = v != null ? v : BigDecimal.valueOf(2.0); }

    public BigDecimal getVolumeMult() { return volumeMult; }
    public void setVolumeMult(BigDecimal v) { this.volumeMult = v != null ? v : BigDecimal.valueOf(2.0); }
    ...
    public void setTpPct(BigDecimal v) { this.tpPct = v != null ? v : BigDecimal.valueOf(3.0); }
